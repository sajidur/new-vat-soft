...
namespace RiceMill_MVC.Report.RPT.Mushak19 {
    ...
    public class rptVatReturn : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "RiceMill_MVC.Report.RPT.Mushak19.rptVatReturn.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptVatReturn : Component, ICachedReport {
        
        public CachedrptVatReturn() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptVatReturn rpt = new rptVatReturn();
            rpt.Site = this.Site;
            return rpt;
        }
